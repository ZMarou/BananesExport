...
public class CommandTest {
    ...
    public void should_return_illegal_argument_exception_when_delivery_date_is_null() {
        IllegalArgumentException exception = assertThrows(IllegalArgumentException.class, () -> new Command(UUID.randomUUID(), null, 0, PRICE_PER_KILO, RECIPIENT));
    ...
    public void should_return_illegal_argument_exception_when_price_per_kilo_is_null() {
        IllegalArgumentException exception = assertThrows(IllegalArgumentException.class, () -> new Command(UUID.randomUUID(), DELIVERY_DATE, 0, null, RECIPIENT));
    ...
    public void should_return_illegal_argument_exception_when_recipient_is_null() {
        IllegalArgumentException exception = assertThrows(IllegalArgumentException.class, () -> new Command(UUID.randomUUID(), DELIVERY_DATE, 0, PRICE_PER_KILO, null));
    ...
    public void should_return_delivery_date_exception_when_delivery_date_dont_respect_regulatory_date() {
        DeliveryDateException exception = assertThrows(DeliveryDateException.class, () -> new Command(UUID.randomUUID(), LocalDate.now().plusDays(6), 0, PRICE_PER_KILO, RECIPIENT));
    ...
    public void should_return_quantity_exception_when_quantity_is_negative() {
        QuantityException exception = assertThrows(QuantityException.class, () -> new Command(UUID.randomUUID(), DELIVERY_DATE, -1, PRICE_PER_KILO, RECIPIENT));
    ...
    public void should_return_quantity_exception_when_quantity_is_more_than_10000() {
        QuantityException exception = assertThrows(QuantityException.class, () -> new Command(UUID.randomUUID(), DELIVERY_DATE, 10005, PRICE_PER_KILO, RECIPIENT));
        assertEquals("Quantity is not supported", exception.getMessage());
    }

    @Test
    public void should_return_quantity_exception_when_quantity_is_not_multiples_of_25() {
        QuantityException exception = assertThrows(QuantityException.class, () -> new Command(UUID.randomUUID(), DELIVERY_DATE, 24, PRICE_PER_KILO, RECIPIENT));
        assertEquals("Quantity is not supported", exception.getMessage());
    }
}
